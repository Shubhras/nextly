...
/* harmony import */ var _util_helpers_func__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1541);
...
const Default = ()=>{
        ...
        products.map((x)=>{
            ...
            if (array) {
                ...
                if (x.selectedVariants !== undefined) {
                    const priceMath = _util_helpers_func__WEBPACK_IMPORTED_MODULE_7__/* ["default"].filter_array_in_obj */ .Z.filter_array_in_obj(resData.variant_products, x.selectedVariants);
    ...
    const getProducts = async ()=>{
        if (basket.length > 0) {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_1___default().post(`${_config__WEBPACK_IMPORTED_MODULE_6__.API_URL}/basket/allproducts`, {
                _id: arrayId
            }).then((res)=>{
    ...
    const getCargoes = async ()=>{
        await axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${_config__WEBPACK_IMPORTED_MODULE_6__.API_URL}/cargoespublic`).then((res)=>{
            if (basket.length > 0) {
