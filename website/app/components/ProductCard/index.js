...
const Default = ({ data = null, className }) => {
   ...
   return (
      ...
      <div className=" m-2 sm:m-3 bg-white group overflow-hidden  pb-0" key={data._id}>
         <div className="  relative cursor-pointer  rounded-lg">
            ...
            {/* <img 
                ...
                onMouseOver={() => {
                imageRef.current.src ="../images/Rectangle1.png"
                }}
                onMouseOut={() => {
                imageRef.current.src ="../images/Rectangle.png"
                 }}
             ...
             />*/}
                  ...
                  <ul className="rating">
                     ...
                     <div className=" font-bold pro-detail w-full h-11 overflow-hidden px-1 mt-2 text-black">
                        {data.title}
                     </div>
                     <div className="  text-md h-12 z-10 relative ">
                        ...
                        <span className=" line-through   w-3/12 float-left ">
                           {!data.type ? (
                              <>
                                 {" "}
                                 {data.before_price != 0 ? (
