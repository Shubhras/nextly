   ...
   return (
      <div>
         <div className="container-custom h-full ">
            <Head title={state.title} description={state.description_short} keywords={state.keys} image={state.allImages.length > 0 ? state.allImages[0].image : ""}/>
         ...
         />
         <div className="mb-12">
            <HomeSeccoundBoxs state={resProductSeccond} title={{ title: "You May Also Like",}} />
         </div>
