...
const Head = dynamic(() =>
    import ("../../app/core/Head"));
const BasketList = dynamic(() =>
    import ("../../app/components/Basket/BasketList"));
const DetailPrice = dynamic(() =>
    import ("../../app/components/Basket/DetailPrice"));

const Page = () => {
    return ( <div className = "container-custom h-full grid grid-cols-12 " >
        <Head title = "Basket" / >
